...
async def main():
    ...
    while running:
        ...
        score_display = Text("you got " + str(score_int), 50, WIDTH//2, 300, (255,255,255))
        score_display.update()

        if (score_int < 200):
            score_comment = Text("You can do better than that...", 50, WIDTH//2, 400, (255,255,255))
            score_comment.update()
        elif(score_int < 600):
            score_comment = Text("You are getting there", 50, WIDTH//2, 400, (255,255,255))
            score_comment.update()
        else:
            score_comment = Text("You are a pro!", 50, WIDTH//2, 400, (255,255,255))
            score_comment.update()
